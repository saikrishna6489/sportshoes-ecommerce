...
<nav class="navbar navbar-expand-lg fixed-top navbar-light headerback"  style="background-color: #e3f2fd;">
  <a class="navbar-brand text-danger logo" href="<%=request.getContextPath()%>/home" style="font-size: 31px; font-weight: bold; ">SportShoes</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
		...
		<c:if test = "${user_id != null }">
        	<p style="padding-right: 16px; padding-top: 15px; font-weight: bold;">Hi <c:out value='${user_name}'/>! </p>
